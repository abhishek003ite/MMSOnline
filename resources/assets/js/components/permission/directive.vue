...
<script>
import permission from '../../directive/permission/index.js'//'@/directive/permission/index.js' // 权限判断指令
import checkPermission from '../../utils/permission.js'//'utils/permission' // 权限判断函数
